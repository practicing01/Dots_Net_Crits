function Module_Reset_Base_Status::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="Reset_Base_Status")
{

%this.Reset_Base_Status(%Parameter_0,%Parameter_1,%Parameter_2);
