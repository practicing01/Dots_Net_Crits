function Module_NPC_King::Variables_Initialize(%this)
{
...
%this.Vector_2D_King_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_King);
...
class="Class_Module_NPC_King_Input_Controller";
...
class="Class_Module_NPC_King_GuiListBoxCtrl_Object_List";
