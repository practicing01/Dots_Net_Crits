function Module_Melee_Vamp::Variables_Initialize(%this)
{
...
class="Class_Module_Melee_Vamp_Input_Controller";
...
class="Class_Module_Melee_Vamp_GuiListBoxCtrl_Object_List";
