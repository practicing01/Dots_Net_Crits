function Module_Attack_Boof::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_Attack_Boof
...
Module_Attack_Boof,"Synchronize_Module_Data"
);//Sender client data.
