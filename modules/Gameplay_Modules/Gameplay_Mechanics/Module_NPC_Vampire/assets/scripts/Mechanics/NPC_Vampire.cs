function Module_NPC_Vampire::NPC_Vampire(%this,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Vector_2D_World_Position,%Int_Gameplay_Object_Counter)
{
...
Image="Module_NPC_Vampire:Image_Summoning_Circle";
...
Animation="Module_NPC_Vampire:Animation_Smoke";

SceneLayer=15;

Module_ID_Parent=%this;

class="Class_NPC_Vampire_Smoke";
...
%Sprite_Vampire=new Sprite()
{

Position=%Vector_2D_World_Position;

Size=%this.Vector_2D_Vampire_Size;

FixedAngle=true;

Image="Module_NPC_Vampire:Image_Vampire";

Animation="Module_NPC_Vampire:Animation_Vampire_Stand_Down";
...
class="Class_Module_NPC_Vampire";

SceneGroup=0;

Collision_Shape_Index=-1;

String_Name="Vampire" SPC %this.Int_Gameplay_Object_Counter;
...
%Sprite_Vampire.SimSet_Foreign_Status=new SimSet();

%Sprite_Vampire.SimSet_Status=new SimSet();

%Sprite_Vampire.SimSet_onRemove_Listeners=new SimSet();

%Sprite_Vampire.SimSet_Animate_Listeners=new SimSet();

%Sprite_Vampire.Collision_Shape_Index=%Sprite_Vampire.createPolygonBoxCollisionShape(%Sprite_Vampire.Size);

%Sprite_Vampire.setCollisionShapeIsSensor(%Sprite_Vampire.Collision_Shape_Index,true);

%this.SimSet_Gameplay_Objects.add(%Sprite_Vampire);

Scene_Dots_Net_Crits.add(%Sprite_Vampire);
