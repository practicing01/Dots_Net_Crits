function Module_NPC_Shield_Generator::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_NPC_Shield_Generator
...
Module_NPC_Shield_Generator,"Synchronize_Module_Data"
);//Sender client data.
