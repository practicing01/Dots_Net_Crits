function Module_Grid_Move::Variables_Initialize(%this)
{
...
class="Class_Module_Grid_Move_Input_Controller";
...
class="Class_Module_Grid_Move_GuiListBoxCtrl_Object_List";
