function Module_NPC_Medic::Recuperate(%this,%GameConnection_Client_Sender,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Second_Module_ID_Parent,%Second_GameConnection_Handle,%Second_Int_Index)
{
...
&&%ScriptObject_Foreign_Status.String_Status$="Recuperate")
{

%ScriptObject_Foreign_Status.Int_Counter--;

if (%ScriptObject_Foreign_Status.Int_Counter<=0)
{

commandToServer('Relay_Module_Function',%Second_Gameplay_Object.Module_ID_Parent,"Remove_Status",
%Second_Gameplay_Object.ScriptObject_Client_Parent.GameConnection_Handle,
%Second_Gameplay_Object.Int_Index,
...
%Gameplay_Object.SimSet_Foreign_Status.remove(%ScriptObject_Foreign_Status);

%ScriptObject_Foreign_Status.delete();
