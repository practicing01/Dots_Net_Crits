function Module_NPC_Medic::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="NPC_Medic")
{

%this.NPC_Medic(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);
...
else if (%Module_Function$="Heal")
{

%this.Heal(%GameConnection_Client_Sender,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4,%Parameter_5);

}
else if (%Module_Function$="Recuperate")
{

%this.Recuperate(%GameConnection_Client_Sender,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4,%Parameter_5);
