function Module_NPC_King::Punch(%this,%GameConnection_Client_Sender,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Second_Module_ID_Parent,%Second_GameConnection_Handle,%Second_Int_Index)
{
...
commandToServer('Relay_Module_Function',%Gameplay_Object.ScriptObject_Client_Parent.Sprite_Player_Sprite.Module_ID_Parent,"Update_Attack",
%Gameplay_Object.ScriptObject_Client_Parent.GameConnection_Handle,
%Gameplay_Object.ScriptObject_Client_Parent.Sprite_Player_Sprite.Int_Index,
10,
1
);

commandToServer('Relay_Module_Function',%Gameplay_Object.ScriptObject_Client_Parent.Sprite_Player_Sprite.Module_ID_Parent,"Update_Speed",
%Gameplay_Object.ScriptObject_Client_Parent.GameConnection_Handle,
%Gameplay_Object.ScriptObject_Client_Parent.Sprite_Player_Sprite.Int_Index,
1,
1
