function Module_Cloak::Variables_Initialize(%this)
{

%this.Vector_2D_Cloak_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Cloak);
...
class="Class_Module_Cloak_Input_Controller";
...
class="Class_Module_Cloak_GuiListBoxCtrl_Object_List";
