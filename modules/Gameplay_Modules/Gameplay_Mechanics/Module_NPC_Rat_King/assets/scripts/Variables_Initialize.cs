function Module_NPC_Rat_King::Variables_Initialize(%this)
{
...
%this.Vector_2D_Rat_King_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Rat_King);

%this.Vector_2D_Rat_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Rat);
...
class="Class_Module_NPC_Rat_King_Input_Controller";
...
class="Class_Module_NPC_Rat_King_GuiListBoxCtrl_Object_List";
