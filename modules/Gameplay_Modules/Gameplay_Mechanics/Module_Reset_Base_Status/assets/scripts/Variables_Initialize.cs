function Module_Reset_Base_Status::Variables_Initialize(%this)
{
...
class="Class_Module_Reset_Base_Status_Input_Controller";
...
class="Class_Module_Reset_Base_Status_GuiListBoxCtrl_Object_List";
