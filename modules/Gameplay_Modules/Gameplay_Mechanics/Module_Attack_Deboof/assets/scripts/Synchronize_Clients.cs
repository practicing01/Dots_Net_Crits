function Module_Attack_Deboof::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_Attack_Deboof
...
Module_Attack_Deboof,"Synchronize_Module_Data"
);//Sender client data.
