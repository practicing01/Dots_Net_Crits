function Module_NPC_Turret::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
Module_NPC_Turret,"Synchronize_Module_Data"
);//Sender client data.
