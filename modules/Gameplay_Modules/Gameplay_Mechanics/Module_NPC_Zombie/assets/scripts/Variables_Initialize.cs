function Module_NPC_Zombie::Variables_Initialize(%this)
{
...
%this.Vector_2D_Zombie_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Zombie);
...
class="Class_Module_NPC_Zombie_Input_Controller";
...
class="Class_Module_NPC_Zombie_GuiListBoxCtrl_Object_List";
