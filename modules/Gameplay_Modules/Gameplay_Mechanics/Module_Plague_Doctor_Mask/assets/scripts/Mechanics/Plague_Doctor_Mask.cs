function Module_Plague_Doctor_Mask::Plague_Doctor_Mask(%this,%GameConnection_Client_Sender,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Second_Module_ID_Parent,%Second_GameConnection_Handle,%Second_Int_Index)
{
...
%Sprite_Plague_Doctor_Mask=new Sprite()
{

Image="Module_Plague_Doctor_Mask:Image_Plague_Doctor_Mask";

Position=%Second_Gameplay_Object.Position;

Size=%this.Vector_2D_Plague_Doctor_Mask_Size;
...
class="Class_Plague_Doctor_Mask";
...
Scene_Dots_Net_Crits.add(%Sprite_Plague_Doctor_Mask);

%Sprite_Plague_Doctor_Mask.Animate(%Second_Gameplay_Object.Float_Angle,%Second_Gameplay_Object.Int_Animation_Type);

%Sprite_Plague_Doctor_Mask.setAnimationFrame(%Second_Gameplay_Object.getAnimationFrame());

%Second_Gameplay_Object.SimSet_onRemove_Listeners.add(%Sprite_Plague_Doctor_Mask);

%Second_Gameplay_Object.SimSet_Animate_Listeners.add(%Sprite_Plague_Doctor_Mask);

%Sprite_Plague_Doctor_Mask.mount(%Second_Gameplay_Object,"0 0",0,0);

%this.SimSet_Masks.add(%Sprite_Plague_Doctor_Mask);
