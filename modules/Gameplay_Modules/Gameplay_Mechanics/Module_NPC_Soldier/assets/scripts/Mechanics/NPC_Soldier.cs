function Module_NPC_Soldier::NPC_Soldier(%this,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Vector_2D_World_Position,%Int_Gameplay_Object_Counter)
{
...
Image="Module_NPC_Soldier:Image_Summoning_Circle";
...
Animation="Module_NPC_Soldier:Animation_Smoke";

SceneLayer=15;

Module_ID_Parent=%this;

class="Class_NPC_Soldier_Smoke";
...
%Sprite_Soldier=new Sprite()
{

Position=%Vector_2D_World_Position;

Size=%this.Vector_2D_Soldier_Size;

FixedAngle=true;

Image="Module_NPC_Soldier:Image_Soldier";

Animation="Module_NPC_Soldier:Animation_Soldier_Stand_Down";
...
class="Class_Module_NPC_Soldier";

SceneGroup=0;

Collision_Shape_Index=-1;

String_Name="Soldier" SPC %this.Int_Gameplay_Object_Counter;
...
%Sprite_Soldier.SimSet_Foreign_Status=new SimSet();

%Sprite_Soldier.SimSet_Status=new SimSet();

%Sprite_Soldier.SimSet_onRemove_Listeners=new SimSet();

%Sprite_Soldier.SimSet_Animate_Listeners=new SimSet();

%Sprite_Soldier.Collision_Shape_Index=%Sprite_Soldier.createPolygonBoxCollisionShape(%Sprite_Soldier.Size);

%Sprite_Soldier.setCollisionShapeIsSensor(%Sprite_Soldier.Collision_Shape_Index,true);

%this.SimSet_Gameplay_Objects.add(%Sprite_Soldier);

Scene_Dots_Net_Crits.add(%Sprite_Soldier);
