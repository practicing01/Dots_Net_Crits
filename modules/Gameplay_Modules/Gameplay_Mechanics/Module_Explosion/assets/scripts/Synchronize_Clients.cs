function Module_Explosion::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
Module_Explosion,"Synchronize_Module_Data"
);//Sender client data.
