function Module_NPC_Artillery::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_NPC_Artillery
...
Module_NPC_Artillery,"Synchronize_Module_Data"
);//Sender client data.
