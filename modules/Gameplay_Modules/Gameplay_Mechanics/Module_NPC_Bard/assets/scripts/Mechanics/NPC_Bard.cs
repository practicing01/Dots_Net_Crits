function Module_NPC_Bard::NPC_Bard(%this,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Vector_2D_World_Position,%Int_Gameplay_Object_Counter)
{
...
Image="Module_NPC_Bard:Image_Summoning_Circle";
...
Animation="Module_NPC_Bard:Animation_Smoke";

SceneLayer=15;

Module_ID_Parent=%this;

class="Class_NPC_Bard_Smoke";
...
%Sprite_Bard=new Sprite()
{

Position=%Vector_2D_World_Position;

Size=%this.Vector_2D_Bard_Size;

FixedAngle=true;

Image="Module_NPC_Bard:Image_Bard";

Animation="Module_NPC_Bard:Animation_Bard_Stand_Down";
...
class="Class_Module_NPC_Bard";

SceneGroup=0;

Collision_Shape_Index=-1;

String_Name="Bard" SPC %this.Int_Gameplay_Object_Counter;
...
%Sprite_Bard.SimSet_Foreign_Status=new SimSet();

%Sprite_Bard.SimSet_Status=new SimSet();

%Sprite_Bard.SimSet_onRemove_Listeners=new SimSet();

%Sprite_Bard.SimSet_Animate_Listeners=new SimSet();

%Sprite_Bard.Collision_Shape_Index=%Sprite_Bard.createPolygonBoxCollisionShape(%Sprite_Bard.Size);

%Sprite_Bard.setCollisionShapeIsSensor(%Sprite_Bard.Collision_Shape_Index,true);

%this.SimSet_Gameplay_Objects.add(%Sprite_Bard);

Scene_Dots_Net_Crits.add(%Sprite_Bard);
