function Class_Module_NPC_Artillery_Input_Controller::onTouchDown(%this,%touchID,%Vector_2D_World_Position)
{
...
commandToServer('Relay_Module_Function',Module_NPC_Artillery,"NPC_Artillery",
...
commandToServer('Relay_Module_Function',Module_NPC_Artillery,%this.Module_ID_Parent.String_Mechanic,
...
function Class_Module_NPC_Artillery_Input_Controller::onTouchUp(%this,%touchID,%Vector_2D_World_Position)
{
...
function Class_Module_NPC_Artillery_Input_Controller::onTouchDragged(%this,%touchID,%Vector_2D_World_Position)
{
