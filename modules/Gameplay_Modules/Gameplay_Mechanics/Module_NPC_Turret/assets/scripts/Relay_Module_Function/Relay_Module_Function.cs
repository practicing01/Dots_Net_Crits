function Module_NPC_Turret::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="NPC_Turret")
{

%this.NPC_Turret(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);
