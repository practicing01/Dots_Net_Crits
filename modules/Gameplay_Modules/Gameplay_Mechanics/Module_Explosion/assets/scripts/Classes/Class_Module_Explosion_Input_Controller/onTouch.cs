function Class_Module_Explosion_Input_Controller::onTouchDown(%this,%touchID,%Vector_2D_World_Position)
{
...
commandToServer('Relay_Module_Function',Module_Explosion,"Explosion",
...
function Class_Module_Explosion_Input_Controller::onTouchUp(%this,%touchID,%Vector_2D_World_Position)
{
...
function Class_Module_Explosion_Input_Controller::onTouchDragged(%this,%touchID,%Vector_2D_World_Position)
{
