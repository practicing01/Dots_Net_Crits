function Module_Speed_Boof::Variables_Initialize(%this)
{

%this.Vector_2D_Speed_Boof_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Speed_Boof);
...
class="Class_Module_Speed_Boof_Input_Controller";
...
class="Class_Module_Speed_Boof_GuiListBoxCtrl_Object_List";
