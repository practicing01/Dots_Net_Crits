function Module_Grid_Move_This::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="Grid_Move_This")
{

%this.Grid_Move_This(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3);
