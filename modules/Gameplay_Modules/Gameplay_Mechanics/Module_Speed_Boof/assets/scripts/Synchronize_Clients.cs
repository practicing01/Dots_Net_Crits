function Module_Speed_Boof::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
Module_Speed_Boof,"Synchronize_Module_Data"
);//Sender client data.
