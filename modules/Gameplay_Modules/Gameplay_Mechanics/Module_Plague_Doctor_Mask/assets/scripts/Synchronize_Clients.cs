function Module_Plague_Doctor_Mask::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_Plague_Doctor_Mask
...
Module_Plague_Doctor_Mask,"Synchronize_Module_Data"
);//Sender client data.
