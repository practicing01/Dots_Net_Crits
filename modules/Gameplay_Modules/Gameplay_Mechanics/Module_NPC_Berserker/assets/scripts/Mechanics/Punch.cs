function Module_NPC_Berserker::Punch(%this,%GameConnection_Client_Sender,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Second_Module_ID_Parent,%Second_GameConnection_Handle,%Second_Int_Index)
{
...
commandToServer('Relay_Module_Function',%Gameplay_Object.Module_ID_Parent,"Update_Attack",
