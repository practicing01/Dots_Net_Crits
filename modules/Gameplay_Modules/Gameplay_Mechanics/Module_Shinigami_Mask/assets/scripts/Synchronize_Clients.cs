function Module_Shinigami_Mask::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_Shinigami_Mask
...
Module_Shinigami_Mask,"Synchronize_Module_Data"
);//Sender client data.
