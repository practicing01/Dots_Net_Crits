function Module_Attack_Deboof::Variables_Initialize(%this)
{

%this.Vector_2D_Attack_Deboof_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Attack_Deboof);
...
class="Class_Module_Attack_Deboof_Input_Controller";
...
class="Class_Module_Attack_Deboof_GuiListBoxCtrl_Object_List";
