function Module_NPC_Dagger::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
Module_NPC_Dagger,"Synchronize_Module_Data"
);//Sender client data.
