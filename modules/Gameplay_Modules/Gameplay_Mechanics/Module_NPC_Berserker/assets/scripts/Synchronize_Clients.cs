function Module_NPC_Berserker::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_NPC_Berserker
...
Module_NPC_Berserker,"Synchronize_Module_Data"
);//Sender client data.
