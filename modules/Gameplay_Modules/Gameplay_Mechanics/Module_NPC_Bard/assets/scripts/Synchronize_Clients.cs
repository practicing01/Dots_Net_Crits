function Module_NPC_Bard::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
Module_NPC_Bard,"Synchronize_Module_Data"
);//Sender client data.
