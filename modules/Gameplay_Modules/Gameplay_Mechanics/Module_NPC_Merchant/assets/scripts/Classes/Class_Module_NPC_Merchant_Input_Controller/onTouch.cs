function Class_Module_NPC_Merchant_Input_Controller::onTouchDown(%this,%touchID,%Vector_2D_World_Position)
{
...
commandToServer('Relay_Module_Function',Module_NPC_Merchant,"NPC_Merchant",
...
commandToServer('Relay_Module_Function',Module_NPC_Merchant,%this.Module_ID_Parent.String_Mechanic,
...
function Class_Module_NPC_Merchant_Input_Controller::onTouchUp(%this,%touchID,%Vector_2D_World_Position)
{
...
function Class_Module_NPC_Merchant_Input_Controller::onTouchDragged(%this,%touchID,%Vector_2D_World_Position)
{
