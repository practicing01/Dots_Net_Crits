function Module_NPC_Dagger::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="NPC_Dagger")
{

%this.NPC_Dagger(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);
...
else if (%Module_Function$="Shank")
{

%this.Shank(%GameConnection_Client_Sender,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4,%Parameter_5);
