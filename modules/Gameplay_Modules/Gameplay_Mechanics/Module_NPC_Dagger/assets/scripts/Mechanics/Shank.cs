function Module_NPC_Dagger::Shank(%this,%GameConnection_Client_Sender,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Second_Module_ID_Parent,%Second_GameConnection_Handle,%Second_Int_Index)
{
...
if (isObject(%Gameplay_Object)&&isObject(%Gameplay_Object.Sprite_Mount_Parent))
{

%Gameplay_Object.Sprite_Mount_Parent.Animate(Vector2AngleToPoint(%Gameplay_Object.Sprite_Mount_Parent.Position,%Second_Gameplay_Object.Position),2);
