function Module_NPC_Barricade::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="NPC_Barricade")
{

%this.NPC_Barricade(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);

}
else if (%Module_Function$="Position_Object")
{

%this.Position_Object(%GameConnection_Client_Sender,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3);
