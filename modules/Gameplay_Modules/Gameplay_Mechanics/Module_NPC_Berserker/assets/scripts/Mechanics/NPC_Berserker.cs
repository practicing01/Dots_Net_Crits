function Module_NPC_Berserker::NPC_Berserker(%this,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Vector_2D_World_Position,%Int_Gameplay_Object_Counter)
{
...
Image="Module_NPC_Berserker:Image_Summoning_Circle";
...
Animation="Module_NPC_Berserker:Animation_Smoke";

SceneLayer=15;

Module_ID_Parent=%this;

class="Class_NPC_Berserker_Smoke";
...
%Sprite_Berserker=new Sprite()
{

Position=%Vector_2D_World_Position;

Size=%this.Vector_2D_Berserker_Size;

FixedAngle=true;

Image="Module_NPC_Berserker:Image_Berserker";

Animation="Module_NPC_Berserker:Animation_Berserker_Stand_Down";
...
class="Class_Module_NPC_Berserker";

SceneGroup=0;

Collision_Shape_Index=-1;

String_Name="Berserker" SPC %this.Int_Gameplay_Object_Counter;
...
%Sprite_Berserker.SimSet_Foreign_Status=new SimSet();

%Sprite_Berserker.SimSet_Status=new SimSet();

%Sprite_Berserker.SimSet_onRemove_Listeners=new SimSet();

%Sprite_Berserker.SimSet_Animate_Listeners=new SimSet();

%Sprite_Berserker.Collision_Shape_Index=%Sprite_Berserker.createPolygonBoxCollisionShape(%Sprite_Berserker.Size);

%Sprite_Berserker.setCollisionShapeIsSensor(%Sprite_Berserker.Collision_Shape_Index,true);

%this.SimSet_Gameplay_Objects.add(%Sprite_Berserker);

Scene_Dots_Net_Crits.add(%Sprite_Berserker);
