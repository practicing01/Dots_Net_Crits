function Module_Snare::Variables_Initialize(%this)
{

%this.Vector_2D_Snare_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Snare);
...
class="Class_Module_Snare_Input_Controller";
...
class="Class_Module_Snare_GuiListBoxCtrl_Object_List";
