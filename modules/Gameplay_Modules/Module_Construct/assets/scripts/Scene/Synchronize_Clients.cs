function Module_Construct::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_Construct

Module_ID_Player_Sprite_Module=0;

Sprite_Player_Sprite=0;

ScriptObject_Player_Sprite_Data=0;
...
Module_Construct,"Synchronize_Module_Data",
%ScriptObject_Client_Copy.Module_ID_Player_Sprite_Module);//Sender client data.
...
%this.Remove_Client(%ScriptObject_Client_Copy);
