function Module_Attack_Boof::Attack_Boof(%this,%GameConnection_Client_Sender,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Second_Module_ID_Parent,%Second_GameConnection_Handle,%Second_Int_Index)
{
...
%Sprite_Attack_Boof=new Sprite()
{

Position=%Second_Gameplay_Object.Position;

Size=%this.Vector_2D_Attack_Boof_Size;

Animation="Module_Attack_Boof:Animation_Attack_Boof";

SceneLayer=15;

Module_ID_Parent=%this;

class="Class_Attack_Boof";

PickingAllowed=false;

};

Scene_Dots_Net_Crits.add(%Sprite_Attack_Boof);
