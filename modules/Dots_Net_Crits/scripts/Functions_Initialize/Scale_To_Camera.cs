...
%Size.X=(%Size.X*Dots_Net_Crits.Resolution.X)/%Ass.Optimal_Resolution.X;

%Size.Y=(%Size.Y*Dots_Net_Crits.Resolution.Y)/%Ass.Optimal_Resolution.Y;
...
%Size.X=(%Size.X*Dots_Net_Crits.Camera_Size.X)/Dots_Net_Crits.Resolution.X;

%Size.Y=(%Size.Y*Dots_Net_Crits.Camera_Size.Y)/Dots_Net_Crits.Resolution.Y;
...
%Vector_2D_Scaled.X-=Dots_Net_Crits.Resolution.X/2;//offset cus cam is from -50 to 50

%Vector_2D_Scaled.Y-=Dots_Net_Crits.Resolution.Y/2;//offset cus cam is from -30 to 30

%Vector_2D_Scaled.Y=-%Vector_2D_Scaled.Y;//flip cus -y is down and +y is up

%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Dots_Net_Crits.Camera_Size.X)/Dots_Net_Crits.Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Dots_Net_Crits.Camera_Size.Y)/Dots_Net_Crits.Resolution.Y;
...
%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Dots_Net_Crits.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Dots_Net_Crits.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Dots_Net_Crits.Camera_Size.X)/Dots_Net_Crits.Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Dots_Net_Crits.Camera_Size.Y)/Dots_Net_Crits.Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Dots_Net_Crits.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Dots_Net_Crits.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Dots_Net_Crits.Resolution.X)/Dots_Net_Crits.Camera_Size.X;

%Vector_2D.Y=(%Vector_2D.Y*Dots_Net_Crits.Resolution.Y)/Dots_Net_Crits.Camera_Size.Y;
