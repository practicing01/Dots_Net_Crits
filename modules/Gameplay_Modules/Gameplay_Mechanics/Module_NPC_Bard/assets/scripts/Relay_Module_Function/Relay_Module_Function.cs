function Module_NPC_Bard::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="NPC_Bard")
{

%this.NPC_Bard(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);
...
else if (%Module_Function$="Inspire")
{

%this.Inspire(%GameConnection_Client_Sender,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4,%Parameter_5);
