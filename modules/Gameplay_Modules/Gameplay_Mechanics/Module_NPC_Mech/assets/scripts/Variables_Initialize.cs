function Module_NPC_Mech::Variables_Initialize(%this)
{
...
%this.Int_Gameplay_Object_Speed=4;
...
%this.Vector_2D_Mech_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Mech);
...
class="Class_Module_NPC_Mech_Input_Controller";
...
class="Class_Module_NPC_Mech_GuiListBoxCtrl_Object_List";
