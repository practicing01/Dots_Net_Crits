function Module_NPC_Shield_Generator::Variables_Initialize(%this)
{
...
%this.Vector_2D_Shield_Generator_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Shield_Generator);

%this.Vector_2D_Shield_Generator_Top_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Shield_Generator_0);

%this.Vector_2D_Hex_Cell_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Hex_Cell);

%this.Int_Hex_Cell_Y_Interval=mRound(%this.Vector_2D_Shield_Generator_Top_Size.Y/%this.Vector_2D_Hex_Cell_Size.Y);
...
class="Class_Module_NPC_Shield_Generator_Input_Controller";
...
class="Class_Module_NPC_Shield_Generator_GuiListBoxCtrl_Object_List";
