function Module_Melee_This::Variables_Initialize(%this)
{
...
class="Class_Module_Melee_This_Input_Controller";
...
class="Class_Module_Melee_This_GuiListBoxCtrl_Object_List";
