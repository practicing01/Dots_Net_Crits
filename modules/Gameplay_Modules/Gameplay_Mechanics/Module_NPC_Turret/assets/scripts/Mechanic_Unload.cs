function Module_NPC_Turret::Mechanic_Unload(%this)
{

if (isObject(%this.ScriptObject_Cancel))
{

%this.ScriptObject_Cancel.ScriptObject_Client_Parent.delete();

%this.ScriptObject_Cancel.delete();
