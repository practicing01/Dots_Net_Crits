function Module_NPC_Merchant::NPC_Merchant(%this,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Vector_2D_World_Position,%Int_Gameplay_Object_Counter)
{
...
Image="Module_NPC_Merchant:Image_Summoning_Circle";
...
Animation="Module_NPC_Merchant:Animation_Smoke";

SceneLayer=15;

Module_ID_Parent=%this;

class="Class_NPC_Merchant_Smoke";
...
%Sprite_Merchant=new Sprite()
{

Position=%Vector_2D_World_Position;

Size=%this.Vector_2D_Merchant_Size;

FixedAngle=true;

Image="Module_NPC_Merchant:Image_Merchant";

Animation="Module_NPC_Merchant:Animation_Merchant_Stand_Down";
...
class="Class_Module_NPC_Merchant";

SceneGroup=0;

Collision_Shape_Index=-1;

String_Name="Merchant" SPC %this.Int_Gameplay_Object_Counter;
...
%Sprite_Merchant.SimSet_Foreign_Status=new SimSet();

%Sprite_Merchant.SimSet_Status=new SimSet();

%Sprite_Merchant.SimSet_onRemove_Listeners=new SimSet();

%Sprite_Merchant.SimSet_Animate_Listeners=new SimSet();

%Sprite_Merchant.Collision_Shape_Index=%Sprite_Merchant.createPolygonBoxCollisionShape(%Sprite_Merchant.Size);

%Sprite_Merchant.setCollisionShapeIsSensor(%Sprite_Merchant.Collision_Shape_Index,true);

%this.SimSet_Gameplay_Objects.add(%Sprite_Merchant);

Scene_Dots_Net_Crits.add(%Sprite_Merchant);
