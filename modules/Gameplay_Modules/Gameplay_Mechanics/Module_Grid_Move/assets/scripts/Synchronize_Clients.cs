function Module_Grid_Move::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
Module_Grid_Move,"Synchronize_Module_Data"
);//Sender client data.
