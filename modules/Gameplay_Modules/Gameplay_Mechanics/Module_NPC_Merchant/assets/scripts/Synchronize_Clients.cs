function Module_NPC_Merchant::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_NPC_Merchant
...
Module_NPC_Merchant,"Synchronize_Module_Data"
);//Sender client data.
