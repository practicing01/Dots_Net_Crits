function Module_NPC_Dagger::Variables_Initialize(%this)
{
...
%this.Vector_2D_Dagger_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Dagger);
...
class="Class_Module_NPC_Dagger_Input_Controller";
...
class="Class_Module_NPC_Dagger_GuiListBoxCtrl_Object_List";
