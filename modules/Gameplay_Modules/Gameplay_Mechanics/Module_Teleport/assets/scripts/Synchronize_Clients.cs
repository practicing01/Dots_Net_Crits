function Module_Teleport::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
Module_Teleport,"Synchronize_Module_Data"
);//Sender client data.
