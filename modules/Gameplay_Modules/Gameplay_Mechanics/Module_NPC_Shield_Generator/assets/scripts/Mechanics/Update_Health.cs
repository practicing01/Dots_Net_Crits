function Module_NPC_Shield_Generator::Update_Health(%this,%GameConnection_Handle,%Int_Index,%Int_Amount,%Char_Mode,%Bool_Camera_Shake,%Float_Shake_Magnitude,%Float_Shake_Time)
{
