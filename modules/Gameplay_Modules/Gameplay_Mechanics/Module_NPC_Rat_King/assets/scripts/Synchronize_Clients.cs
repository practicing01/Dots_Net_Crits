function Module_NPC_Rat_King::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_NPC_Rat_King
...
Module_NPC_Rat_King,"Synchronize_Module_Data"
);//Sender client data.
