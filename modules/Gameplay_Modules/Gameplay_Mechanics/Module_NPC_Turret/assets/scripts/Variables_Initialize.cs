function Module_NPC_Turret::Variables_Initialize(%this)
{
...
%ScriptObject_Client_Parent=new ScriptObject()
{

GameConnection_Handle=-1;

};

%this.ScriptObject_Cancel=new ScriptObject()
{

Module_ID_Parent=%this;

ScriptObject_Client_Parent=%ScriptObject_Client_Parent;
...
%this.Vector_2D_Turret_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Turret);

%this.Vector_2D_Shell_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Shell);
...
class="Class_Module_NPC_Turret_Input_Controller";
...
class="Class_Module_NPC_Turret_GuiListBoxCtrl_Object_List";
