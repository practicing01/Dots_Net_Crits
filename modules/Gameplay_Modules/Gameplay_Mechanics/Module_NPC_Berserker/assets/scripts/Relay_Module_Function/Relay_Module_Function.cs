function Module_NPC_Berserker::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="NPC_Berserker")
{

%this.NPC_Berserker(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);
