function Class_Module_NPC_Turret_GuiListBoxCtrl_Object_List::onDoubleClick(%this)
{
...
if (%this.Module_ID_Parent.String_Mechanic$="Fire")
{

%this.Module_ID_Parent.Object_Mechanic_Second_Target=%this.Module_ID_Parent.Picked_Object;

if (%this.Module_ID_Parent.Object_Mechanic_Second_Target.ScriptObject_Client_Parent.GameConnection_Handle!=-1)
{

commandToServer('Relay_Module_Function',Module_NPC_Turret,%this.Module_ID_Parent.String_Mechanic,
...
function Class_Module_NPC_Turret_GuiListBoxCtrl_Object_List::onSelect(%this)
{
...
function Class_Module_NPC_Turret_GuiListBoxCtrl_Object_List::onMouseDragged(%this)
{
