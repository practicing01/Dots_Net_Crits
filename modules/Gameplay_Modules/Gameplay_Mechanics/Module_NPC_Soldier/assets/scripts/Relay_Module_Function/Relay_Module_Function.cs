function Module_NPC_Soldier::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="NPC_Soldier")
{

%this.NPC_Soldier(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);
