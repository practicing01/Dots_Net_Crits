function Module_NPC_Merchant::Variables_Initialize(%this)
{
...
%this.Vector_2D_Merchant_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Merchant);
...
class="Class_Module_NPC_Merchant_Input_Controller";
...
class="Class_Module_NPC_Merchant_GuiListBoxCtrl_Object_List";
