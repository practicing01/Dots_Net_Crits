function Module_Kitsune_Mask::Kitsune_Mask(%this,%GameConnection_Client_Sender,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Second_Module_ID_Parent,%Second_GameConnection_Handle,%Second_Int_Index)
{
...
%Sprite_Kitsune_Mask=new Sprite()
{

Image="Module_Kitsune_Mask:Image_Kitsune_Mask";

Position=%Second_Gameplay_Object.Position;

Size=%this.Vector_2D_Kitsune_Mask_Size;
...
Scene_Dots_Net_Crits.add(%Sprite_Kitsune_Mask);

%Sprite_Kitsune_Mask.Animate(%Second_Gameplay_Object.Float_Angle,%Second_Gameplay_Object.Int_Animation_Type);

%Sprite_Kitsune_Mask.setAnimationFrame(%Second_Gameplay_Object.getAnimationFrame());

%Second_Gameplay_Object.SimSet_onRemove_Listeners.add(%Sprite_Kitsune_Mask);

%Second_Gameplay_Object.SimSet_Animate_Listeners.add(%Sprite_Kitsune_Mask);

%Sprite_Kitsune_Mask.mount(%Second_Gameplay_Object,"0 0",0,0);

%this.SimSet_Masks.add(%Sprite_Kitsune_Mask);
