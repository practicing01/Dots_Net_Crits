function Module_NPC_Soldier::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_NPC_Soldier
...
Module_NPC_Soldier,"Synchronize_Module_Data"
);//Sender client data.
