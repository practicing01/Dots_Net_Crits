function Module_NPC_Rat_King::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="NPC_Rat_King")
{

%this.NPC_Rat_King(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);

}
else if (%Module_Function$="Spawn_Token")
{

%this.Spawn_Token(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3);
...
else if (%Module_Function$="Scratch")
{

%this.Scratch(%GameConnection_Client_Sender,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4,%Parameter_5);
