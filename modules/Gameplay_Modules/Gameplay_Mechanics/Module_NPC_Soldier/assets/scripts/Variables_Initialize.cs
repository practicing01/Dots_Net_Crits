function Module_NPC_Soldier::Variables_Initialize(%this)
{
...
%this.Vector_2D_Soldier_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Soldier);
...
class="Class_Module_NPC_Soldier_Input_Controller";
...
class="Class_Module_NPC_Soldier_GuiListBoxCtrl_Object_List";
