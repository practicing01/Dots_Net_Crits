function Module_NPC_Bard::Variables_Initialize(%this)
{
...
%this.Vector_2D_Bard_Size=Vector_2D_Ass_Size_To_Camera_Scale(%this.Ass_Image_Bard);
...
class="Class_Module_NPC_Bard_Input_Controller";
...
class="Class_Module_NPC_Bard_GuiListBoxCtrl_Object_List";
