function Module_Melee_Vamp::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
Module_Melee_Vamp,"Synchronize_Module_Data"
);//Sender client data.
