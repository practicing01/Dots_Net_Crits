function Module_NPC_King::NPC_King(%this,%Module_ID_Parent,%GameConnection_Handle,%Int_Index,%Vector_2D_World_Position,%Int_Gameplay_Object_Counter)
{
...
Image="Module_NPC_King:Image_Summoning_Circle";
...
Animation="Module_NPC_King:Animation_Smoke";

SceneLayer=15;

Module_ID_Parent=%this;

class="Class_NPC_King_Smoke";
...
%Sprite_King=new Sprite()
{

Position=%Vector_2D_World_Position;

Size=%this.Vector_2D_King_Size;

FixedAngle=true;

Image="Module_NPC_King:Image_King";

Animation="Module_NPC_King:Animation_King_Stand_Down";
...
class="Class_Module_NPC_King";

SceneGroup=0;

Collision_Shape_Index=-1;

String_Name="King" SPC %this.Int_Gameplay_Object_Counter;
...
%Sprite_King.SimSet_Foreign_Status=new SimSet();

%Sprite_King.SimSet_Status=new SimSet();

%Sprite_King.SimSet_onRemove_Listeners=new SimSet();

%Sprite_King.SimSet_Animate_Listeners=new SimSet();

%Sprite_King.Collision_Shape_Index=%Sprite_King.createPolygonBoxCollisionShape(%Sprite_King.Size);

%Sprite_King.setCollisionShapeIsSensor(%Sprite_King.Collision_Shape_Index,true);

%this.SimSet_Gameplay_Objects.add(%Sprite_King);

Scene_Dots_Net_Crits.add(%Sprite_King);
