function Module_Reset_Base_Status::Synchronize_Clients(%this,%ScriptObject_Client,%Bool_Connected)
{
...
//Specific to Module_Reset_Base_Status
...
Module_Reset_Base_Status,"Synchronize_Module_Data"
);//Sender client data.
