function Module_NPC_Merchant::Relay_Module_Function(%this,%GameConnection_Client_Sender,%Module_Function,
...
if (%Module_Function$="NPC_Merchant")
{

%this.NPC_Merchant(%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);
