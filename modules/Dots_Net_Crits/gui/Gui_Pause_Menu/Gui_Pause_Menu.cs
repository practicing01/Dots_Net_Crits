...
Dots_Net_Crits.add(TamlRead("./Gui_Pause_Menu.gui.taml"));

}

exec("./Buttons/Go_Main_Menu.cs");

function Dots_Net_Crits::Toggle_Pause_Menu(%this)
{
...
GlobalActionMap.bindCmd(keyboard,"escape","Dots_Net_Crits.Toggle_Pause_Menu();","");
